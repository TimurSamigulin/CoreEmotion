...
class BertToxic():
    ...
    max_len = 512
    tokenizer = BertTokenizer.from_pretrained('app/models/rubert-toxic-detection')
    model = BertForSequenceClassification.from_pretrained('app/models/rubert-toxic-detection')
